package com.lovelycatv.crystal.rag.repository
...
import com.lovelycatv.crystal.rag.query.ElasticSearchQueryConditionTranslator
...
class ElasticSearchVectorRepository(
    ...
    options: VectorRepositoryOptionsDTO,
    ...
    override fun similaritySearch(query: VectorDocumentSimilarQueryDTO): List<VectorDocument> {
        require(this.isRepositoryExists()) { "Index ${this.getRepositoryName()} not found" }
